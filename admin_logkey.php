         ...
         <table id="students">  
                ...
                ?>
                        <tr>
                            ...
                            <?php echo '<td><a href= "admin_changeUser.php?id=',$rows['id'],'">Change Username</a></td>';?>
                            <?php echo '<td><a href= "admin_changePass.php?id=',$rows['id'],'">Change Password</a></td>';?>
                           <?php
                            if($rows['id'] != "334556198"){
                                $delkey=$rows['id'].","."logkey";
